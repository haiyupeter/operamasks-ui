...
function publish(symbolSet) {
	...
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.jsDir+"om-core.js", publish.conf.outDir+"/"+publish.conf.jsDir);
	//added by chenjie
	...
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.imagesDir+"header_bg.png", publish.conf.outDir+"/"+publish.conf.imagesDir);
	
	//added by chenjie
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.tabImagesDir+"om-tabs-bg-a.png", publish.conf.outDir+"/"+publish.conf.tabImagesDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.tabImagesDir+"om-tabs-bg-d.png", publish.conf.outDir+"/"+publish.conf.tabImagesDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.tabImagesDir+"om-tabs-bg-h.png", publish.conf.outDir+"/"+publish.conf.tabImagesDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.tabImagesDir+"om-tabs-closebtn.gif", publish.conf.outDir+"/"+publish.conf.tabImagesDir);
